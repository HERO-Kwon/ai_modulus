...
v12_2_9: conf more interface
v12_2_10: no u v prev diff
v12_2_11: inlet p
v12_2_12: fixed int pnt up
''' 
...
@modulus.main(config_path="conf", config_name="config_coating_v13_2")
def run(cfg: ModulusConfig) -> None:
    ...
    ic_highres = PointwiseInteriorConstraint(
        nodes=nodes,
        geometry=geo,
        outvar={"net_p_prev_step_diff": 0, "net_a_prev_step_diff": 0},
