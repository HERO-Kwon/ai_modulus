...
v2_7_1: slurry 물성
v3: 물성 전체 조정, hi-res 영역 변경
'''

@modulus.main(config_path="conf", config_name="config_coating_v3_gcp")
def run(cfg: ModulusConfig) -> None:
    ...
    highres_interior1 = PointwiseInteriorConstraint(
        ...
        criteria=And((x>=(Lf+Ld)),(x<=(right_rx+right_r)),(y>=H0),(y<=(right_ry+right_r))),
        parameterization=time_range,
    )
