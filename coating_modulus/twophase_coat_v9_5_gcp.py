...
-v9_5: from 9_3 5k step, outlet a 1, impmes +10, size 256
-gcp: no pressure penalty
'''
...
@modulus.main(config_path="conf", config_name="config_coating_v9_1")
def run(cfg: ModulusConfig) -> None:
    ...
    inlet = PointwiseBoundaryConstraint(
        ...
        lambda_weighting={"u": 100.0, "v": 100.0, "a":1.0},#, "p":1.0},
    ...
    plate = PointwiseBoundaryConstraint(
        ...
        outvar={"u": Uw ,"v":0},
        batch_size=cfg.batch_size.no_slip,
        lambda_weighting={"u": 100.0, "v": 100.0},
        criteria=Eq(y,0.0),
        parameterization=time_range,
    )
